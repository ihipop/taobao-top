...
class SecurityUtil
{
    ...
    */
    ...
    function isIndexEncrypt($key, $version, $secretContext)
    {
        ...
        return $secretContext->appConfig != null && array_key_exists($key, $secretContext->appConfig) && $secretContext->appConfig[$key] == "2";
    }
    ...
    function getSlideWindows($input, $slideSize = 4)
    {
        ...
        while ($endIndex < $dataLength || $currentWindowSize > $slideSize) {
            ...
            if ($currentWindowSize == $slideSize && $startsWithLetterOrDigit == false && $this->isLetterOrDigit($this->utf8_str_at($input, $endIndex))) {
                $endIndex++;
